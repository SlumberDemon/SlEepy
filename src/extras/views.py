    ...
    async def callback(self, interaction: discord.Interaction):
        if interaction.user == self.ctx.author:
            if int(self.values[0]) == 0:
                ...
                Utility.add_field(name='**User**', value='Shows user info', inline=False)
                Utility.add_field(name='**Avatar**', value='Shows user avatar', inline=False)
                Utility.add_field(name='**Source**', value='Shows bot source', inline=False)
                ...
                Mod.add_field(name='**Unban**', value='Unban user', inline=False)
                Mod.add_field(name='**Giveaway**', value='Giveaway command', inline=False)
